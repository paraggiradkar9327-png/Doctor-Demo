  ...
  return (
    <div>
      ...
      <div
        ...
        className={`relative flex flex-col items-center justify-center gap-2 rounded-xl border-2 border-dashed p-4 min-h-30 cursor-pointer duration-200 transition-colors ${
          dragging
